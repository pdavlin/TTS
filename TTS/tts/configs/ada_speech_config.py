...
from TTS.tts.models.ada_speech import AdaSpeechArgs


@dataclass
class AdaSpeechConfig(BaseTTSConfig):
    """Configure an AdaSpeech model.
    ...
    Args:
        model (str):
            Model name used for selecting the right model at initialization. Defaults to `ada_pitch`.
        ...
        model_args (Coqpit):
            Model class arguments. Check `AdaSpeechArgs` for more details. Defaults to `AdaSpeechArgs()`.
